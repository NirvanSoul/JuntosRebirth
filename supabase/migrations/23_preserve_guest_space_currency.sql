-- 23_preserve_guest_space_currency.sql
-- Preserva la moneda enviada en cada espacio durante la migración de datos de invitado.
-- Aplica lógica asimétrica: los espacios nuevos sin moneda usan 'EUR' como fallback histórico,
-- mientras que los espacios existentes conservan su spaces.currency si el cliente no envía currency.
