...
> Checklist del §52 de `Legal/JUNTOSS_LEGAL_PRIVACY_SYSTEM.md`. Última actualización: 2026-08-07.
...
- [x] **SDKs incluidos** — inventariados en `docs/privacy/SDK_INVENTORY.md`: solo Supabase y módulos Expo de almacenamiento/notificaciones; ninguno de terceros con fines publicitarios o analíticos.
...
- [ ] **SDK privacy manifests** — Supabase JS no es un SDK nativo (no aporta manifest propio); confirmar que los módulos nativos de Expo usados incluyen su propio `PrivacyInfo.xcprivacy` en la versión instalada.
